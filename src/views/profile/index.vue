...
<template>
  ...
  >
    <div
      class="relative max-w-screen-lg mx-auto bg-white dark:bg-zinc-900 duration-500 xl:rounded-sm xl:dark:border-zinc-600 xl:border-[1px] xl:px-4 xl:py-2"
    >
      <!-- 移动端 navbar -->
      ...
      <div class="h-full w-full px-1 pb-4 text-sm mt-2 xl:w-2/3 xl:pb-0">
        ...
        <div class="py-1 xl:absolute xl:right-[16%] xl:text-center">
          ...
          >
            ...
            />
            <div
              class="absolute top-0 rounded-[50%] w-full h-full bg-[rgba(0,0,.4)] hidden xl:group-hover:block"
            >
              <m-svg-icon
