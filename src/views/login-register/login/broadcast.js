...
// 官方声明 safari 支持 BroadcastChannel ，但是实测 15.3 的的版本并不支持，所以需要对其进行判定使用，在不支持 BroadcastChannel 的浏览器中，使用 localstorage
...
/**
 * 等待 QQ 登录成功
 * 因为 QQ 登录会在一个新的窗口中进行，用户扫码登录成功之后会回调《新窗口的 QC.Login 第二个参数 cb》，而不会回调到原页面。
